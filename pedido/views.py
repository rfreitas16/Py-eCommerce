...
class Pagar(DispathLoginRequired, DetailView):
    ...
    #intervir na query do url para filtrar para somente o usuario ver os pedidos dele
    ...
    def get(self, *args, **kwargs):
        ...
        for variacao in bd_variacoes:
            ...
            if estoque < qtd_carrinho:
                ...
                'Reduzimos a quantidades desses produtos. Por favor, verifique no seu carrinho'\
                'quais dos produtos foram afetados a seguir'
        ...
        #registando pedido na base de dados
        pedido = Pedido(
